...
// --- DEFER INITIALIZATION UNTIL SOLANA LIBS ARE LOADED ---

let PurchaseHandler;
let accountLayout;
let transferInstructionData;
...
function initializePurchaseHandler() {
    ...
    console.log('Solana libraries loaded, initializing PurchaseHandler...');
    ...
    // state/account.js
    accountLayout = solana.bufferLayout.struct([
    ...
    transferInstructionData = solana.bufferLayout.struct([solana.bufferLayout.u8('instruction'), solana.bufferLayout.u64('amount')]);
